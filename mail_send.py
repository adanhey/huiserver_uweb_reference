...
class SendMail:
    ...
    def send_mail(self):
        ...
        # addressee = 'zhengjunpeng@inovance.com'
        ...
        self.mail.HtmlBody = "本次通过率: %s<br>失败用例：%s<br>allure报告地址：https://0012-1302444590.cos.ap-beijing.myqcloud.com/reports/index.html" % (
